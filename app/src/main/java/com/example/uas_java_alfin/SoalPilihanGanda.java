...
public class SoalPilihanGanda {
    ...
    public String pertanyaan[] = {
            ...
            "Tanggal 10 November diperingati sebagai hari apa ...",
            "Nama lapangan yang digunakan sebagai tempat berlangsungnya proklamasi adalah ...",
            "Tempat soekarno Hatta dibawa oleh golongan muda untuk diamankan dari pengaruh Jepang adalah ...",
            "Siapakah yang menjahit bendera Merah Putih ...",
            "Joglo merupakan rumah adat daerah ...",
    };
    ...
    private String pilihanJawaban[][] = {
            ...
            {"Hari Pahlawan","Hari Pancasila","Hari Ulang Tahun Saya"},
            {"Lapangan Belakang Kelurahan","Lapangan Ikada","Lapangan Futsal"},
            {"Pekalongan","Jakarta","Rengasdengklok"},
            {"Sayuti Melik","Fatmawati","Laksamana Maeda"},
            {"Jawa Tengah","Jakarta","Kalimantan"},
